...
export default class extends Controller {
  ...
  initializeColumnVisibility() {
    ...
    const columnsToHide = ['start-date', 'end-date', 'status', 'responsible', 'accountable']
  ...
  showColumn(column) {
    ...
    const toggleIcon = toggleButton.querySelector('i') // This is the toggle button icon
    const columnData = this.element.querySelectorAll(`tbody [data-column="${column}"]`)
    const headerCell = this.element.querySelector(`thead th[data-column="${column}"]`)
  ...
  getVisibleColumns() {
    ...
    const columnsToCheck = ['start-date', 'end-date', 'status', 'responsible', 'accountable']
  ...
  updateTableContainerClass() {
    ...
    const allColumns = ['start-date', 'end-date', 'status', 'responsible', 'accountable']
